...
getSymbols("USDBRL=X", scr = "yahoo", from = "2020-01-01", to = "2021-09-30")
...
```{r echo=FALSE}
 ...
 ggplot()+
  ...
  scale_x_date(date_labels = "%b\n%Y", breaks = "12 month", expand = c(0.025,0.01)) +
...
ggplot()+
  ...
  scale_x_date(date_labels = "%Y", breaks = "1 year", expand = c(0.03,0.001),
               limits = as.Date(c("1999-01-01","2021-09-01")))+
...
knitr::kable(head(tabela_dolar),
             ...
             caption = "Referência: Setembro/2021")
```
    </div>
  </div>
</div>
...
knitr::kable(head(produtos_export),
             ...
             col.names = c("Produto",
                           "Valor exportado em Setembro/21 (US$)",
                           "Variação (12 meses)",
                           "Variação mensal"),
             caption = "Produtos mais exportados no mês (Referência: Setembro/2021)") %>% 
...
knitr::kable(head(produtos_import),
             ...
             align = "c",
             col.names = c("Produto",
                           "Valor importado em Setembro/21 (US$)",
                           "Variação (12 meses)",
                           "Variação mensal"),
             caption = "Produtos mais importados no mês (Referência: Setembro/2021)") %>% 
               kable_styling(font_size = 11) 
